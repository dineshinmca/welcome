...
class Alwaysoffer_Ajaxcart_CartController extends Mage_Checkout_CartController
{
    /**
    ...
    public function addAction()
    {
		...
		if($params['isAjax'] == 1){
			...
			{
				$response['message'] = $this->getLayout()->createBlock('Checkout/Cart_Minicart')->setTemplate('checkout/cart/minicart.phtml')->toHtml();
